    ...
    <section id='about-us' className='bg-[#f2f2f2] py-16 sm:py-20'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6'>
        <div className='grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-start'>
          <div className='border-l border-slate-500 pl-6 sm:pl-7'>
            <h2 className='font-serif text-4xl font-medium uppercase tracking-wide text-slate-900 sm:text-5xl'>
              Who We Are
            </h2>

            <p className='mt-4 max-w-xl text-lg leading-9 text-slate-700'>
              Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
              there live the blind texts. Separated they live in Bookmarksgrove right at the coast of
              the Semantics, a large language ocean.
            </p>

            <ol className='mt-10 space-y-6 text-lg leading-9 text-slate-800'>
              <li>
            ...
            <button className='mt-10 rounded-xl bg-[#22123d] px-8 py-3 text-lg font-semibold text-white hover:bg-[#140a29]'>
              More About Us →
            </button>
          </div>
          ...
          <div className='grid gap-3 sm:grid-cols-[190px_1fr]'>
            <div className='grid grid-rows-3 gap-3'>
              <img
                ...
                alt='Team member'
                className='h-36 w-full object-cover sm:h-[152px]'
              />
              <img
            ...
            <img
              ...
              className='h-full min-h-[320px] w-full object-cover sm:min-h-[468px]'
            />
          </div>
        </div>
      </div>
